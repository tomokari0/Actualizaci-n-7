...
export const TRANSLATIONS: Record<string, Record<string, string>> = {
    'en': {
        ...
        submitText: 'Submit your masterpiece to be featured on SeikoYT.',
        title: 'Title',
        type: 'Type',
        ...
        submitBtn: 'Submit Content',
        submitting: 'Submitting...',
        submissionReceived: 'Submission Received!',
        thankYou: 'Thank you for sharing your creation with SeikoYT. We have received your details via email and will review them shortly.',
    ...
    'es-419': {
        ...
        submitText: 'Envía tu obra maestra para ser destacada en SeikoYT.',
        title: 'Título',
        type: 'Tipo',
        ...
        submitBtn: 'Enviar Contenido',
        submitting: 'Enviando...',
        submissionReceived: '¡Envío Recibido!',
        thankYou: 'Gracias por compartir tu creación con SeikoYT. Hemos recibido tus detalles y los revisaremos pronto.',
    ...
    'ja': {
        ...
        submitText: 'SeikoYTで紹介されるためにあなたの傑作を提出してください。',
        title: 'タイトル',
        type: 'タイプ',
        description: '説明',
        genre: 'ジャンル（カンマ区切り）',
        ...
        submitBtn: 'コンテンツを提出',
        submitting: '送信中...',
        submissionReceived: '提出を受け付けました！',
        thankYou: 'SeikoYTとあなたの作品を共有していただきありがとうございます。詳細を受け取りましたので、間もなく確認いたします。',
