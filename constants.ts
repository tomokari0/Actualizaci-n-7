...
export const TRANSLATIONS: Record<string, Record<string, string>> = {
    'en': {
        ...
        close: 'Close',
        changelogTitle: 'What\'s New in SeikoYT',
        ...
        aboutUs: 'About SeikoYT',
        aboutText1: 'SeikoYT is a leading video streaming platform dedicated to bringing you the best in entertainment. From gripping dramas and hilarious comedies to action-packed adventures, our curated library offers something for everyone.',
    ...
    'es-419': {
        ...
        close: 'Cerrar',
        changelogTitle: 'Novedades en SeikoYT',
        ...
        aboutUs: 'Sobre SeikoYT',
        aboutText1: 'SeikoYT es una plataforma líder de transmisión de video dedicada a brindarte lo mejor en entretenimiento. Desde dramas apasionantes y comedias divertidas hasta aventuras llenas de acción, nuestra biblioteca seleccionada ofrece algo para todos.',
    ...
    'ja': {
        ...
        termsOfService: '利用規約',
        aboutUs: 'SeikoYTについて',
        aboutText1: 'SeikoYTは、最高のエンターテイメントをお届けすることに専念する主要なビデオストリーミングプラットフォームです。魅力的なドラマや陽気なコメディからアクション満載の冒険まで、厳選されたライブラリは誰にでも楽しめるものを提供しています。',
